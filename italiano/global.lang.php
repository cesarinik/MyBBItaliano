...
$l['bottomlinks_forumteam'] = 'Staff';
$l['bottomlinks_contactus'] = 'Contattaci';
$l['bottomlinks_returntop'] = 'Torna in alto';
$l['bottomlinks_syndication'] = 'RSS Syndication';
$l['bottomlinks_litemode'] = 'Lite (Archive) Mode';
$l['bottomlinks_markread'] = 'Segna tutti come letti';

$l['welcome_usercp'] = 'Pannello controllo utente';
$l['welcome_modcp'] = 'Pannello controllo Moderatore';
$l['welcome_admin'] = 'Pannello controllo ADMIN';
$l['welcome_logout'] = 'Log Out';
$l['welcome_login'] = 'Entra';
$l['welcome_register'] = 'Registrati';
$l['welcome_open_buddy_list'] = 'Apri lista contatti';
$l['welcome_newposts'] = 'Vedi nuovi post';
$l['welcome_todaysposts'] = 'Vedi post di oggi';
$l['welcome_pms'] = 'Messaggi Privati';
$l['welcome_pms_usage'] = '(Non letti {1}, Totale {2})';
$l['welcome_back'] = '<strong>Bentornato, {1}</strong>. Ultimo login: {2}';
$l['welcome_guest'] = 'Ciao Ospite!';
$l['welcome_current_time'] = '<strong>Ora attuale:</strong> {1}';
...
$l['forumbit_posts'] = 'Post';
$l['forumbit_lastpost'] = 'Ultimo messaggio';
$l['forumbit_moderated_by'] = 'Moderatore:';
$l['new_posts'] = 'Forum Contains New Posts';
$l['no_new_posts'] = 'Forum Contains No New Posts';
$l['click_mark_read'] = 'Contrassegna come letto';
$l['forum_closed'] = 'Forum chiuso';
$l['forum_redirect'] = 'Reindirizzamento Forum';
...
$l['password_required'] = 'Password richiesta';
...
$l['short_thursday'] = 'Gio';
$l['short_friday'] = 'Ven';
$l['short_saturday'] = 'Sab';
$l['short_sunday'] = 'Dom';
...
$l['thread_subscription_method_desc'] = 'Specify the type of notification and thread subscription you would like to have to this thread. (Registered users only)';
...
$l['editor_alignleft'] = 'A sinistra';
$l['editor_center'] = 'Centrato';
$l['editor_alignright'] = 'A destra';
$l['editor_justify'] = 'Giustificato';
$l['editor_fontname'] = 'Font';
$l['editor_fontsize'] = 'Dimensione';
$l['editor_fontcolor'] = 'Colore';
$l['editor_removeformatting'] = 'Cancella formattazione';
$l['editor_cut'] = 'Taglia';
$l['editor_copy'] = 'Copia';
...
$l['editor_redo'] = 'Ripeti';
$l['editor_rows'] = 'Righe:';
$l['editor_cols'] = 'Colonne:';
$l['editor_inserttable'] = 'Inserisci tabella';
$l['editor_inserthr'] = 'Inserisci linea orizzontale';
$l['editor_code'] = 'Codice';
$l['editor_php'] = 'PHP';
$l['editor_width'] = 'Larghezza (opzionale):';
$l['editor_height'] = 'Altezza (opzionale):';
$l['editor_insertimg'] = 'Inserisci immagine';
$l['editor_email'] = 'Email:';
$l['editor_insertemail'] = 'Inserisci email';
$l['editor_url'] = 'URL:';
$l['editor_insertlink'] = 'Inserisci collegamento';
$l['editor_unlink'] = 'Scollega';
$l['editor_more'] = 'Altro';
$l['editor_insertemoticon'] = 'Inserisci emoticon';
$l['editor_videourl'] = 'Video URL:';
$l['editor_videotype'] = 'Tipo Video:';
$l['editor_insert'] = 'Inserisci';
$l['editor_insertyoutubevideo'] = 'Inserisci video YouTube';
$l['editor_currentdate'] = 'Inserisci data';
$l['editor_currenttime'] = 'Inserisci ora';
$l['editor_print'] = 'Stampa';
$l['editor_viewsource'] = 'Vedi sorgente';
$l['editor_description'] = 'Descrizione (opzionale):';
$l['editor_enterimgurl'] = 'Inserisci URL immagine:';
$l['editor_enteremail'] = 'Inserisci l\'indirizzo email:';
$l['editor_enterdisplayedtext'] = 'Inserisci un testo:';
$l['editor_enterurl'] = 'Inserisci URL:';
$l['editor_enteryoutubeurl'] = 'Inserisci indirizzo video YouTube video URL o ID:';
$l['editor_insertquote'] = 'Inserisci citazione';
...
$l['editor_insertvideo'] = 'Inserisci video';
$l['editor_maximize'] = 'Massimizza';
...
$l['postbit_website'] = 'Visita il sito dell\'utente';
...
$l['error_banned'] = 'Spiacenti, sei stato bannato. Non puoi postare, leggere discussioni o accedere al forum. Contatta gli amministratori per avere ulteriori informazioni.';
...
$l['invalid_nocaptcha'] = 'Risolvi  reCAPTCHA per verificare che non sei un robot.';
$l['invalid_hcaptcha'] = 'Risolvi hCaptcha per verificare che non sei un robot.';
...
$l['timezone_gmt_100'] = '(GMT +1:00) Berlin, Brussels, Madrid, Paris, Rome';
...
$l['dismiss_notice'] = 'Cancella questo avviso';
...
$l['board_name'] = 'Nome Forum';
$l['board_url'] = 'Indirizzo Forum';

$l['comma'] = ', ';

$l['debug_generated_in'] = 'Generato in {1}';
$l['debug_weight'] = '({1}% PHP / {2}% {3})';
$l['debug_sql_queries'] = 'Query SQL: {1}';
$l['debug_server_load'] = 'Carico del server: {1}';
$l['debug_memory_usage'] = 'Utilizzo memoria: {1}';
$l['debug_advanced_details'] = 'Dettagli completi';

$l['error_emailflooding_1_second'] = 'Spiacente, puoi inviare una sola email ogni {1} secondo. Attendi 1 secondo per riprovare.';
$l['error_emailflooding_seconds'] = 'Spiacente, puoi inviare una sola email ogni {1} secondi. Attendi {2} secondi per riprovare.';
$l['error_emailflooding_1_minute'] = 'Spiacente, puoi inviare una sola email ogni {1} minuto. Attendi 1 minuto per riprovare.';
$l['error_emailflooding_minutes'] = 'Spiacente, puoi inviare una sola email ogni {1} minuti. Attendi {2} minuti per riprovare.';
$l['error_invalidfromemail'] = 'Non hai inserito un nome valido.';
$l['error_noname'] = 'Non hai inserito un indirizzo email valido.';
$l['your_email'] = 'La tua email:';
$l['email_note'] = 'Inserisci qui il tuo indirizzo email.';
$l['your_name'] = 'Il tuo nome:';
$l['name_note'] = 'Inserisci qui il tuo nome.';
...
$l['boardclosed_reason'] = 'Questo forum è chiuso per manutenzione. Ritenta tra qualche minuto';
