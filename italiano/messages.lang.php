...
$l['error_invalidannouncement'] = 'L\'annuncio specificato non esiste.';
...
$l['error_usernametaken'] = 'Il nome utente che hai scelto è già registrato. Se sei già registrato clicca su <a href="member.php?action=login">login</a>.';
...
$l['error_reachedattachquota'] = 'Non puoi allegare questo file perchè hai raggiunto il limite per i tuoi allegati ({1})';
$l['error_maxattachpost'] = 'Non puoi allegare questo file perchè hai raggiungo il numero massimo degli allegati per messaggio ({1})';
...
$l['emailsubject_reportprofile'] = 'Utente segnalato a {1}';
$l['emailsubject_reportreputation'] = 'Reputazione segnalata a {1}';
$l['emailsubject_reachedpmquota'] = 'Limite di Messaggi Privati raggiunto da {1}';
$l['emailsubject_changeemail'] = 'Cambio indirizzo email di {1}';
$l['emailsubject_newpm'] = 'Nuovo Messaggio Privato di {1} - {2}';
...
Dovrai inserire le seguenti informazioni:
Nome utente: {1} (Oppure il tuo indirizzo email)
Codice di Attivazione: {5}
...
$l['email_reportprofile'] = '{1} ha segnalato da {2} il seguente utente:
...
Questo messaggio è stato inviato a tutti i moderatori di questo forum, o a tutti gli amministratori e super amministratori se non ci sono moderatori.

Si è pregati di controllare questa reputazione il prima possibile.';
$l['email_reportreputation'] = '{1} ha segnalato da {2} la seguente reputazione:
...
E\' raccomandato che cambi la tua password subito dopo il login. Puoi farlo andando nel Pannello di Controllo Utente e selezionando Cambia Password nel menu a sinistra.
...
Nome utente: {3} (Oppure il tuo indirizzo email)
Password: {4}
...
{2} ha appena risposto alla discussione a cui ti sei sottoscritto su {3}. La discussione si intitola {4}.
...
Ci potrebbero essere altre nuove risposte ma non riceverai altre notifiche finchè non visiterai di nuovo la board.
...
Questa è un\'email automatica da {2} per informarti che hai raggiunto il limite di capacità nella casella In Arrivo dei tuoi Messaggio Privati.
...
Abbiamo ricevuto una richiesta il {2} per cambiare il tuo indirizzo email (guarda i dettagli sottostanti).
...
Questa modifica è stata effettuata automaticamente. Se non hai richiesto questa modifica si prega di contattare un Amministratore.
...
Ricevi questa email perchè tu o qualcuno con le tue credenziali di accesso ha recentemente cambiato la password del tuo account.

Nome Utente: {1}
Indirizzo Email: {2}

Se non hai effettuato questa modifica si prega di contattare un Amministratore.
...
Hai ricevuto un nuovo messaggio privato su {3} da {2}: 

------------------------------------------
{5}
------------------------------------------

Per leggere, rispondere o inoltrare questo messaggio, puoi andare su questo link:
...
{2} ha richiesto di iscriversi a {3} su {4} (vedi sotto).

Motivo: {5}

Per accettare o rifiutare questa richiesta vai al seguente URL:
{6}/managegroup.php?gid={7}

Grazie,
Lo Staff di {4}';
$l['email_contact_subject'] = 'Contatto: {1}';
$l['email_contact'] = 'E-mail: {1}
Forum profile: {2}
IP Address: {3}
Messaggio:
{4}';
$l['pmsubject_subscription'] = 'Nuova risposta a {1}';
$l['pm_subscription'] = '{1},

{2} ha appena risposto alla discussione a cui ti sei sottoscritto. La discussione si intitola {3}.
...
$l['email_broken_task'] = 'La tua copia di MyBB su {1} ({2}) ha avuto un errore con il task system.

Il file task per {3} risulta mancante.

Questa task è stata disattivata fino a che il problema non sarà risolto.';
$l['update_confirm'] = 'I seguenti file sono già allegati e verranno aggiornati/sostituiti con quelli appena selezionati. {1} Sei sicuro?';
$l['error_updatefailed'] = 'Il file "{1}" non è già allegato e non può essere aggiornato.';
$l['error_attach_filename_length'] = 'Il nome file \'{1}\' supera la lunghezza massima del nome file {2}. Carica un file con un nome file più breve.';
