...
$l['d3_name'] = 'Uso dei cookie in MyBB';
$l['d3_desc'] = 'MyBB utilizza i cookie per salvare alcune informazioni circa la tua registrazione.';
$l['d3_document'] = 'MyBB fa uso dei cookie per tenere traccia delle informazioni sul tuo login se sei registrato o sulla tua ultima visita se non lo sei.
...
<br /><br />Per cancellare tutti i cookie impostati da questa board, puoi cliccare <a href=\'misc.php?action=clearcookies&amp;my_post_key={1}\'>qui</a>.';
